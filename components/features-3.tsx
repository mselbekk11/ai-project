  ...
  return (
    <section className="bg-zinc-50 py-16 md:py-32 dark:bg-transparent">
      <div className="@container mx-auto max-w-5xl px-6">
        ...
        <Card className="mx-auto mt-8 grid grid-cols-1 md:grid-cols-3 max-w-full divide-y md:divide-y-0 md:divide-x overflow-hidden shadow-zinc-950/5 *:text-center md:mt-16">
